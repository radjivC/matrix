	...
	$(document).ready(function() {
		...
		$(window).scroll(function() {
			...
			$('.navbar-nav > li > a').each(function() {
				...
				if(thisHref == "http://kangou.mx/pickUps/add")
					return;
			...
			rules:{ 
				first_name:{
					...
					messages:{
							...
							email:{
								required: "Requerimos de tu email para contactarte",
								email: "Tu correo debe ser de la forma nombre@dominio.com"
							}, 
							message:{
								required: "Por favor inserta más de 2 letras"
							}, 
						}
		});			
